...
#define MP3_DECODE_EXPORT  __attribute ((visibility("default")))

/* public API */
MP3_DECODE_EXPORT HMP3Decoder MP3InitDecoder(void);
MP3_DECODE_EXPORT void MP3FreeDecoder(HMP3Decoder hMP3Decoder);
MP3_DECODE_EXPORT int MP3Decode(HMP3Decoder hMP3Decoder, unsigned char **inbuf, int *bytesLeft, short *outbuf, int useSize);

MP3_DECODE_EXPORT void MP3GetLastFrameInfo(HMP3Decoder hMP3Decoder, MP3FrameInfo *mp3FrameInfo);
MP3_DECODE_EXPORT int MP3GetNextFrameInfo(HMP3Decoder hMP3Decoder, MP3FrameInfo *mp3FrameInfo, unsigned char *buf);
MP3_DECODE_EXPORT int MP3FindSyncWord(unsigned char *buf, int nBytes);
